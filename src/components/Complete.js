...
export default function Complete() {
  ...
  //every two seconds, when loading, change the loading text from this array
  ...
  const getAnswerToast = async () => {
    ...
    const getAnswer = new Promise(async (resolve, reject) => {
      ...
      const response = await fetch(
        `https://codedaywhatifbackend.hrichik.xyz/whatif`,
        {
          method: 'POST',
          headers: {
  ...
  //every two seconds, when loading, change the subHeading from this array


  return (
    <>
      <section className="w-full min-h-screen py-12 md:py-24 lg:py-32 xl:py-48 bg-black">
